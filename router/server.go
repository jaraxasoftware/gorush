...
import (
	...
	"github.com/jaraxasoftware/gorush/metric"
	"github.com/jaraxasoftware/gorush/notify"
...
func versionHandler(c *gin.Context) {
	c.JSON(http.StatusOK, gin.H{
		"source":  "https://github.com/jaraxasoftware/gorush",
		"version": GetVersion(),
	})
}
...
func pushHandler(cfg *config.ConfYaml, q *queue.Queue) gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		go func() {
			...
			// https://github.com/jaraxasoftware/gorush/issues/422
			if cfg.Core.Sync {
				cancel()
			}
		}()
